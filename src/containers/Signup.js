...
import {
  HelpBlock, FormGroup, FormControl, ControlLabel } from "react-bootstrap";
    ...
    return (
      <form onSubmit={handleConfirmationSubmit}>
        <FormGroup controlId="confirmationCode" bsSize="large">
          ...
          />
          <HelpBlock>Please check your email for the code. Confirmation can take a few minutes.</HelpBlock>
        </FormGroup>
        <LoaderButton
          block
          type="submit"
